    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='Введите номер телефона', max_length=15, null=True, verbose_name='Номер телефона')),
                ...
                ('tg_token', models.CharField(blank=True, help_text='Введите токен пользователя в телеграм', max_length=150, null=True, verbose_name='Токен телеграмм')),
